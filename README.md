...
Agentic RAG → NETCONF XML → Orchestrator‑Worker DAG execution with a NiceGUI frontend, powered by the Microsoft Agent Framework (MAF).

---

## 🚀 Overview  
This project demonstrates an **Agentic RAG–driven network automation workflow** using the **Microsoft Agent Framework (MAF)**.  
...
> **Demonstration: Multi-Task DAG Execution via MAF**
...
- NiceGUI
- FAISS
- Microsoft Agent Framework (MAF) 1.4.0
